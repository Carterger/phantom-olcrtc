...
> менеджер с маскировкой трафика под видеозвонок Wildberries

Phantom позволяет поднять собственный сервер и управлять подключениями через удобную панель. Трафик маскируется под видеозвонок Wildberries — один из самых надёжных способов обхода блокировок в России.
